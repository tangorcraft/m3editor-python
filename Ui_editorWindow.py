...
class Ui_m3ew(object):
    def setupUi(self, m3ew):
        ...
        self.fieldsTable = QtWidgets.QTableView(self.splitter_2)
        ...
        self.fieldsTable.horizontalHeader().setDefaultSectionSize(150)
        ...
        self.actionreset_model = QtWidgets.QAction(m3ew)
        self.actionreset_model.setObjectName("actionreset_model")
    ...
    def retranslateUi(self, m3ew):
        ...
        self.actionreset_model.setText(_translate("m3ew", "reset model"))
